package com.rifara.siklushidup.crud_sqlite;
...
import com.rifara.siklushidup.crud_sqlite.adapter.NoteAdapter;
import com.rifara.siklushidup.crud_sqlite.db.NoteHelper;
import com.rifara.siklushidup.crud_sqlite.entity.Note;
import com.rifara.siklushidup.crud_sqlite.helper.MappingHelper;
...
public class MainActivityCrud extends AppCompatActivity implements LoadNotesCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new NoteAdapter((selectedNote, position) -> {
            Intent intent = new Intent(MainActivityCrud.this, NoteAddUpdateActivity.class);
